...
_MIGRATIONS_SQL = [
    ...
    # v0.2: drop news-boards tables (idempotent — IF EXISTS)
    "DROP TABLE IF EXISTS board_seen_item",
    "DROP TABLE IF EXISTS board_news_item",
    "DROP TABLE IF EXISTS board_run",
